// Run the server first then run this on a different console app.
// just copy and paste the code below into a new console app file and run it.
using System;
using System.Text;
using System.Net;
...
namespace TcpChatViewerExample
{
  class TcpChatViewer
  {
    // Connection objects
